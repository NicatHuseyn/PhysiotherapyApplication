...
namespace PhysiotherapyApplication.Persistence.Migrations
{
    ...
    [Migration("20250201002228_DeleteDateOfBithColumn")]
    partial class DeleteDateOfBithColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhysiotherapyApplication.Domain.Entities.DoctorDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysiotherapyApplication.Domain.Entities.IdentityModels.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("PhysiotherapyApplication.Domain.Entities.PatientDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PhysiotherapyApplication.Domain.Entities.Doctor", b =>
                {
                    b.HasBaseType("PhysiotherapyApplication.Domain.Entities.IdentityModels.ApplicationUser");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("PhysiotherapyApplication.Domain.Entities.IdentityModels.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PhysiotherapyApplication.Domain.Entities.DoctorDetail", b =>
                {
                    b.HasOne("PhysiotherapyApplication.Domain.Entities.Doctor", null)
                        ...
                        .HasForeignKey("PhysiotherapyApplication.Domain.Entities.DoctorDetail", "DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PhysiotherapyApplication.Domain.Entities.PatientDetail", b =>
                {
                    b.HasOne("PhysiotherapyApplication.Domain.Entities.Patient", null)
                        .WithOne("PatientDetail")
                        .HasForeignKey("PhysiotherapyApplication.Domain.Entities.PatientDetail", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
